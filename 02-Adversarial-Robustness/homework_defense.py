...
def train(args, model, device, train_loader, optimizer, epoch, train_nat=False, beta=6.0):
    model.train()
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        # calculate robust loss
        ######################################################
        # Change loss computing algorithm
        if not train_nat:
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train(args, model, device, train_loader, optimizer, epoch, train_nat=(epoch==1))
        ######################################################
    ...
    ###################################
    # You should that change those codes
    ###################################
