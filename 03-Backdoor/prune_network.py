...
parser.add_argument('--mask-file', type=str, default='./mask_out/mask_values.txt', help='The text file containing the mask values')

parser.add_argument('--pruning-by', type=str, default='threshold')
